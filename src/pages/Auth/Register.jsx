    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-lg bg-card rounded-3xl p-6 shadow-soft space-y-5">
        ...
        <div className="flex justify-between items-center">
          <h2 className="text-2xl font-display font-bold text-card-foreground">Register</h2>
        ...
        <div className="flex justify-center items-center space-x-2">
          <span className="font-display text-sm text-card-foreground">Already have an account?</span>
          <SoftButton
            variant="secondary"
            size="sm"
